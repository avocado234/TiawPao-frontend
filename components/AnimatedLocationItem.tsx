...
const AnimatedLocationItem = ({ plan_id, loc, onDelete, isEditMode, isFirst }: { plan_id: any, loc: any; onDelete: (placeId: string) => void; isEditMode: boolean; isFirst: boolean }) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            //     const payload = { place_id: loc.place_id };
            //     console.log(payload , idToken, plan_id, loc.place_id);
            //   await api.delete(`/plan/deletetriplocation/${plan_id}`,{
            //     data: payload,
            //     headers: {
